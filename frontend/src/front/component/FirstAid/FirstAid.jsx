            ...
            <>
                ...
                <div className='faid'>
                    <div className='p-2 lang'>
                        <Link id='lang1' className="btn  active" aria-current="page" to="/Robot-Care/firstaid">En</Link>
                        <Link id='lang2' className="btn lang2 active" to="/Robot-Care/firstaidar">العربيه</Link>
