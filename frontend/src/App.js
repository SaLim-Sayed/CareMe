...
import List from "./front/component/Prediction/List";
import Predict from "./front/component/Prediction/Predict";
    ...
    <div style={{ backgroundColor: '#031425' }} className="App">
      <Router>
        <Switch>
          ...
          />
          <Route exact path="/Robot-Care" component={Chatbot} />
          {/* <Route exact path="/">
          <Redirect to="/Robot-Care" />
        </Route> */}
          <Route exact path="/Robot-Care/Home">
            <Redirect to="/" />
          </Route>
          <Route exact path="/Robot-Care/About" component={About} />
          <Route exact path="/Robot-Care/FirstAid" component={FirstAid} />
          <Route exact path="/Robot-Care/firstaidar" component={FirstAidAr } />
...
<Route exact path="/" component={Chatbot} />
          ...
          <ProtectRoute path='/Robot-Care/Home' component={Messenger} exact /> */